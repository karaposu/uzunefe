...
float        aci_eksi_sinir=-3,        aci_arti_sinir=3;  //min negatitive and positive angle borders for balance robo9
...
settings();
 dt=2;                 //miliseconds
 Timer1.initialize(200000); // set timer  for every ... ms and calculate pid again in each period
