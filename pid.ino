...
if (pwm_cikis<-255){pwm_cikis=-255;}
                 ...
                 if (pwm_cikis < 0) {pwm_cikis=-1*pwm_cikis;}
                  if(inside_the_space_beyond_our_dimension==0){
                       ...
                       //  case 3:increase_speed_from_negative_moment(pwm_cikis);break;
                              case 6:speedless_zone();;break;
                            default: inside_the_space_beyond_our_dimension=1; break;
    ...
    Serial.print("                                    ");    Serial.print(" "); Serial.print(" "); Serial.print(" "); Serial.print(" ");     Serial.print(" "); Serial.println(counter);
      counter++;
